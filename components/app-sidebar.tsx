...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
                                            ...
                                            <DropdownMenu>
                                                <DropdownMenuTrigger asChild>
                                                    <SidebarMenuButton className="d-flex flex-row w-full">
                                                        <img src={user?.photoURL ?? ""} alt="User avatar" width={30} height={30} className="max-w-[30px] max-h-[30px] rounded-full flex-auto" />
    ...
    else return <div>Loading on app sidebar...</div>;
}
